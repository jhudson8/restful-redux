...
The `SEARCH` action prefix is defined by the [action creator](https://github.com/jhudson8/react-redux-model/blob/master/examples/simple-fetch-with-redux-effects/lib/profile-page/actions.js#L4) `actionPrefix` option value.
